...
import com.fantastic.filterableadapter.CircleTransform
import com.fantastic.filterableadapter.FilterableAdapter
...
class MainActivity : AppCompatActivity() {
  ...
  { "name": "Harvey Wallbanger",
    ...
    var filterableAdapter: FilterableAdapter<Cocktail>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val getImageSelector = {

            val random = Random();

            val urls =
            arrayOf(
                "https://live.staticflickr.com/7098/6894089272_62e1bec3a3_q_d.jpg",
                "https://live.staticflickr.com/5007/5240760596_d2b5f91bbf_q_d.jpg",
                "https://live.staticflickr.com/2020/1959004487_8929dae417_q_d.jpg",
                "https://live.staticflickr.com/89/219034347_1c81550694_q_d.jpg",
                "https://live.staticflickr.com/6017/5986834390_525744154c_q_d.jpg",
                "https://live.staticflickr.com/3744/11892969254_685a4e5628_q_d.jpg",
                "https://live.staticflickr.com/6071/6131018441_36b917b647_q_d.jpg",
                "https://live.staticflickr.com/4144/4950718961_c740b257e0_q_d.jpg",
                "https://live.staticflickr.com/175/475011634_b07ae3bf05_q_d.jpg",
                "https://live.staticflickr.com/4144/4950718961_c740b257e0_q_d.jpg",
                "https://live.staticflickr.com/4012/4665992422_a0a8ddbbf1_q_d.jpg",
                "https://live.staticflickr.com/6024/5878166419_bb4d94a14c_q_d.jpg",
                "https://live.staticflickr.com/3526/3979205355_bcf926eca5_q_d.jpg",
                "https://live.staticflickr.com/5269/5694235190_086f35c839_q_d.jpg",
                "https://live.staticflickr.com/6017/5986834390_525744154c_q_d.jpg"
                );


            { urls[random.nextInt(14)]}
        }

        val selectImage = getImageSelector();

        val createView = { parent: ViewGroup, _ : Int  ->

            val view = layoutInflater.inflate(R.layout.item, parent, false);

            val cocktailName = view.findViewById<TextView>(R.id.cocktailName)
            ...
            val numberOfIngredients = view.findViewById<TextView>(R.id.numberOfIngredients)

            val updateView : (Cocktail) -> Unit = {cocktail: Cocktail ->

                cocktailName.text = cocktail.name;
                category.text = cocktail.category;
                preparation.text = cocktail.preparation;
                numberOfIngredients.text = "# ${cocktail.ingredients.size}";

                val pictureSize = 75;

                picasso
                    .load(selectImage())
                    .resize(pictureSize, pictureSize)
                    .centerCrop()
                    .transform(CircleTransform())
                    .into(picture);
            };

            Pair<View, (Cocktail) -> Unit> (view, updateView);
        };
        ...
        ).parse(Cocktail.serializer().list, data)
         .sortedBy { it.name }

        filterableAdapter =
            FilterableAdapter(cocktails,
                createView,
                {searchTerm -> cocktails.filter { it.name.startsWith(searchTerm, true) }});

        recycler.setAdapter(filterableAdapter);
    ...
    @Serializable
    data class Ingredient(val unit: String = "",
